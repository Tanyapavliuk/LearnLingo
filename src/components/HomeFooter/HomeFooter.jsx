...
export const HeroFooter = () => {
  return (
    <footer className="mx-4 lg:px-[4rem] @container/footer">
      <ul className=" grid grid-cols-2 grid-rows-2 gap-y-3 lg:flex lg:justify-between @[0rem]/footer:px-[9cqw] rounded-[30px] border-accent border-dashed border-2 py-10">
